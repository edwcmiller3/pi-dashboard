// The Meteocons MONO icon pack (IconPack, see core/contract.js): maps a semantic
...
// renderIcon builds an <i class="wx-icon wx-<name>"> the mono pack.css paints via
// a CSS mask over currentColor (the glyph inherits text color); `extra` appends a
// caller class for sizing/color. The name is an OWN value (a server-resolved token
// or a fixed chrome name), so it is safe in the class attribute; human text never
// flows here.
//
