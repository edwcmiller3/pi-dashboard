...
real calendar) — generated by a local, untracked helper (`tools/mockup.py`,
git-ignored) that injects a fixture cache into a locally-run server and
screenshots it with headless Chrome. The frame exercises most UI states:
